...
float atSingleton_1308_g(float a, double b) { (void)a; (void)b; return 0.0f; }
...
void pongCreatureInst_9030_g(void* a, void* b) { (void)a; (void)b; }
...
void fiAsciiTokenizer_0BA8_g(void* a, int b) { (void)a; (void)b; }
uint8_t fiAsciiTokenizer_2110_gen(void* a, void* b, void* c) { (void)a; (void)b; (void)c; return 0; }
void fiAsciiTokenizer_3310_g(void* a) { (void)a; }
...
void ke_A428(void* a) { (void)a; }
void ke_C750(void* a) { (void)a; }
void ke_D440(void* a) { (void)a; }
...
void phJoint_1618_g(phJoint3Dof* a) { (void)a; }
