...
static_assert(sizeof(TimerAlert) <= 32, "TimerAlert must fit in 32-byte slot");
static_assert(offsetof(Timer, m_alerts) == 44, "Timer alerts array must be at offset 44");
static_assert(offsetof(Timer, m_alertCount) == 172, "Timer alert count must be at offset 172");
