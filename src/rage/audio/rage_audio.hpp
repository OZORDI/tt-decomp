 ...
 *
 * Struct layouts and virtual slot tables are populated.  Method
 * signatures for unlifted slots remain as vfn_N; cross-ref
 * recomp/structured_pass5_final/ when lifting.
 */
#pragma once
#include <stdint.h>
